...
function updateUIText() {
    ...
    document.getElementById('settingsTitle').innerHTML = `<span class="icon">🎯</span> ${t('settings')}`;
    document.getElementById('btnNewGame').textContent = `🔄 ${t('newGame')}`;
    document.getElementById('btnSwitchSides').textContent = `🔀 ${t('switchSides')}`;
    document.getElementById('btnUndo').textContent = `↩️ ${t('undo')}`;
    document.getElementById('lblAiDifficulty').textContent = `⚙️ ${t('aiDifficulty')}`;
    ...
    document.getElementById('lblCaptured').textContent = t('captured');
    document.getElementById('lblWhiteCaptured').innerHTML = `<span class="icon">⚪</span> ${t('whiteCaptured')}`;
    document.getElementById('lblBlackCaptured').innerHTML = `<span class="icon">⚫</span> ${t('blackCaptured')}`;
    document.getElementById('historyTitle').innerHTML = `<span class="icon">📜</span> ${t('moveHistory')}`;
